...
@media (min-width: 992px) {
  ...
  <div class="site-wrapper-inner">
    <div class="cover-container">
      <div class="masthead clearfix">
        <div class="inner">
          ...
          <nav class="nav nav-masthead">
            ...
            <a class="nav-link nav-social" href="register">Register</a>
          </nav>
        </div>
      </div>
      <br>
      ...
      <div class="mastfoot">
        <div class="inner">
            <p>© CityBook. Developed By  <a href="https://citybook.co.in/" target="_blank" title="Web Code Services">Web Code Services</a>.</p>
        </div>
      </div>
  </div>
</div>
