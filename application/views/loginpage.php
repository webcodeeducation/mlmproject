...
<body>
    <div id="logreg-forms">
      ...
      <?php
        ...
        ?>
        <form action="<?php echo base_url('loginme'); ?>" class="form-signin" method="post">
            ...
            <form action="registeruser" class="form-signup" method="post">
                <div class="social-login">
                ...
                <input type="password" id="user-repeatpass" name="cpassword" class="form-control" placeholder="Repeat Password" required autofocus="">
...
})g" target="_blank" style="color:black">By Web Code Education</a>
    </p>
